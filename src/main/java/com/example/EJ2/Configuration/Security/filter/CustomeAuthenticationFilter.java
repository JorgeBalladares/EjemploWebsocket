package com.example.EJ2.Configuration.Security.filter;
...
public class CustomeAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        log.info("Usuario es : "+ usuario); log.info("Password es : " + password);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws IOException, ServletException {
        ...
        String refresh_token = JWT.create()
                ...
                .sign(algorithm);
                    //---Así conseguimos reflejarlo en headers pero no es útil
        /*response.setHeader("access_token", access_token);
        response.setHeader("refresh_token", refresh_token);*/
            //-----Mapeaos y lo mostramos como respuesta
